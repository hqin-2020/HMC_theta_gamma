...
python3 -u /home/pengyu/HMC/HMC_theta_gamma/sampler.py  --pf 20.76 --pa 44.75 --time 200 --theta 1.0 --gamma 1.0 --sitenum 25 --xi 0.1 --weight 0.1 --dataname test1 --mix_in 2 --mass_matrix_gamma 1.0 --mass_matrix_theta 20000  --symplectic_integrator_num_steps 20 
